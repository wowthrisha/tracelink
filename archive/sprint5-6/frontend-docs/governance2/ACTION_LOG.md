...
Migrated from `docs/engineering/ACTION_LOG.md` on 2026-06-22 (A-144).
...
| # | Action | File | Change |
|---|---|---|---|
| A-144 | CREATE | `docs/governance/ACTION_LOG.md` | Migrated from `docs/engineering/ACTION_LOG.md`; added unified governance header |
| A-145 | CREATE | `docs/governance/RISK_REGISTER.md` | Unified register: FE-R- (163 entries from frontend) + BE-R- (15 entries from root) + GOV-R- (6 new governance risks) |
| A-146 | DELETE | `FRONTEND_ARCHITECTURE_REVIEW.md` | Critically stale — claimed app.jsx = 6,046 lines; reality = 5 lines; actively misleading |
| A-147 | DELETE | `FRONTEND_REFACTOR_PLAN.md` | Obsolete — described ViewerScreen extraction as pending; completed in Sprint 4.2D |
| A-148 | DELETE | `REPOSITORY_CLEANUP_PLAN.md` (root) | Superseded by `docs/governance/REPOSITORY_CLEANUP_PLAN.md` |
| A-149 | DELETE | `ENTERPRISE_READINESS_AUDIT.md` | Superseded by `PRODUCTION_READINESS_AUDIT.md` |
| A-150 | DELETE | `IMPLEMENTATION_VERIFICATION_REPORT.md` | Superseded by `SECURITY_AUDIT_REPORT.md` (2026-06-17) |
| A-151 | DELETE | `SECURITY_VERIFICATION_AUDIT.md` | Superseded by `SECURITY_AUDIT_REPORT.md` (2026-06-17) |
| A-152 | DELETE | `ENTERPRISE_REVALIDATION_REPORT.md` | One-time historical pass; no unique content |
| A-153 | DELETE | `].md` | 31,909-byte exact duplicate of TRACEVIEW_PILOT_DEPLOYMENT_GUIDE.md; shell artifact |
| A-154 | DELETE | `ALL_ACTION_DESIGNS.md` | 0 bytes — empty file |
| A-155 | DELETE | `ACTION_1_DESIGN.md` through `ACTION_12_DESIGN.md` (12 files) | Implemented features; design docs are historical artifacts |
| A-156 | DELETE | `ACTION_13_DESIGN.md` through `ACTION_20_DESIGN.md` (7 files) | Confirmed implemented in backend routers; design docs are historical artifacts |
| A-157 | DELETE | `docs/engineering/DOCS_MIGRATION_LOG.md` | Migration complete; content captured in A-131–A-136 |
| A-158 | DELETE | 8 completed frontend sprint plans | All sprints executed; content preserved in ACTION_LOG |
| A-159 | MARK | 13 root-level archive docs | Added HISTORICAL ARCHIVE banner |
| A-160 | MARK | 12 frontend archive docs | Added HISTORICAL ARCHIVE banner |
| A-161 | CREATE | `docs/governance/DOCUMENT_INVENTORY.md` | Phase 1 — 91-file inventory with classification |
| A-162 | CREATE | `docs/governance/DOCUMENT_CONFLICTS.md` | Phase 3 — 11 conflicts identified |
| A-163 | CREATE | `docs/governance/REPOSITORY_CLEANUP_PLAN.md` | Phase 4 — 12-step execution plan |
| A-164 | CREATE | `docs/governance/CODEBASE_GOVERNANCE_AUDIT.md` | Phase 5 — zero dead code, 2 open security items |
| A-165 | CREATE | `docs/governance/EXECUTIVE_RECOMMENDATION.md` | Phase 6 — recommendations and governance rules |
| A-166 | MODIFY | `docs/engineering/ACTION_LOG.md` | Added MIGRATED redirect notice pointing to governance location |
| A-167 | MODIFY | `docs/risks/RISK_REGISTER.md` | Added MIGRATED redirect notice pointing to governance location |
| A-168 | MODIFY | `docs/governance/SPRINT4_3_SECURITY_HARDENING_PLAN.md` | Noted: R-065 (React CDN pin) resolved — CDN pinned with SRI in SecureDoc.html |
