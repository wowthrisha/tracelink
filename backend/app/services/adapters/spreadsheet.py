"""Spreadsheet document adapters: XLSX."""
...
class XLSXAdapter(DocumentAdapter):
    """Excel spreadsheet adapter — image pipeline via LibreOffice."""
    ...
    async def process(
        ...
        from app.workers.pipeline.xlsx_pdf import process_xlsx_as_pdf
        return await process_xlsx_as_pdf(
